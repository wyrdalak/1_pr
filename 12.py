...
class FaceRecognitionApp:
    ...
    def _reset_employee_screen(self):
        ...
        for n in names:
            env_menu.add_command(label=n, command=tk._setit(self.employee_env, n))
        if names:
    ...
    def _prepare_manager(self):
        ...
        names = [e['name'] for e in self.environments]
        for n in names:
            env_menu.add_command(label=n, command=tk._setit(self.manager_env, n, self._load_manager_env))
        if names:
