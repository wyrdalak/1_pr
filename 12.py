...
class FaceRecognitionApp:
    ...
    def _build_security_frame(self):
        ...
        self.security_video.pack(expand=True, fill='both')

        right = tk.Frame(content, bg='#2c3e50', width=300)
        right.pack(side='left', fill='y', padx=10, pady=10)
        right.pack_propagate(False)
        ttk.Label(right, text='Нарушения', style='Title.TLabel').pack(pady=5)
        self.warning_text = scrolledtext.ScrolledText(right, width=40, font=("Courier", 12))
